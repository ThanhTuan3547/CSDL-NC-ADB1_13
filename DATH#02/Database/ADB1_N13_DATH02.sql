...
(
	TAIKHOANID INT NOT NULL PRIMARY KEY,
...
ADD CONSTRAINT FK_TAIKHOAN_NHANVIEN
	FOREIGN KEY (MANV) REFERENCES TAIKHOAN(TAIKHOANID)
GO
ALTER TABLE KHACHHANG
ADD CONSTRAINT FK_TAIKHOAN_KHACHHANG
	FOREIGN KEY (MAKH) REFERENCES TAIKHOAN(TAIKHOANID)
GO
ALTER TABLE QUANTRI
ADD CONSTRAINT FK_TAIKHOAN_QUANTRI
	FOREIGN KEY (MAQT) REFERENCES TAIKHOAN(TAIKHOANID)
GO